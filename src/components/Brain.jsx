...
function Brain({ scrollYProgress }) {
  ...
  return (
    <div className='h-full w-full'>
      <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" version="1.1" id="Capa_1" width="800px" height="800px" viewBox="0 0 418.879 418.879">
        <g>
          <g
            fill='pink'>
            <motion.path
